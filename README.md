...
Try to change: \
T in loss.py&emsp;&emsp;means distillation temperature.\
lamda in loss.py&emsp;&emsp;lamba is the balance factor to balance hard-label loss and soft-label loss. 
