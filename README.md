...
Try to change: \
&emsp;&emsp;T in loss.py&emsp;&emsp;means distillation temperature.\
&emsp;&emsp;lamda in loss.py&emsp;&emsp;amba is the balance factor to balance hard-label loss and soft-label loss. 
